...
object Blocks {
    ...
    val DARK_GREEN = register("dark_green", Block(FabricBlockSettings.copy(Blocks.WHITE_CONCRETE)))
    val BLUE = register("blue", Block(FabricBlockSettings.copy(Blocks.WHITE_CONCRETE)))
    val DARK_BLUE = register("dark_blue", Block(FabricBlockSettings.copy(Blocks.WHITE_CONCRETE)))
    ...
    val DARK_GRAY = register("dark_gray", Block(FabricBlockSettings.copy(Blocks.WHITE_CONCRETE)))
