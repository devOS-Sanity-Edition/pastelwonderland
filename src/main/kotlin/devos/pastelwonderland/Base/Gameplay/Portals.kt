...
object Portals {
    fun init() {
        ...
        CustomPortalApiRegistry.addPortal(Blocks.DARK_RED, Identifier(PW_MOD_ID, "pastel_dim"), 216, 65, 37)
        ...
        CustomPortalApiRegistry.addPortal(Blocks.DARK_GREEN, Identifier(PW_MOD_ID, "pastel_dim"), 28, 123, 80)
        CustomPortalApiRegistry.addPortal(Blocks.BLUE, Identifier(PW_MOD_ID, "pastel_dim"), 116, 209, 234)
        CustomPortalApiRegistry.addPortal(Blocks.DARK_BLUE, Identifier(PW_MOD_ID, "pastel_dim"), 28, 123, 80)
        ...
        CustomPortalApiRegistry.addPortal(Blocks.DARK_GRAY, Identifier(PW_MOD_ID, "pastel_dim"), 28, 123, 80)
